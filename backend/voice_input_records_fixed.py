# -*- coding: utf-8 -*-
# Useful for Windows console Unicode support
import sys
import io
...
try:
    ...
    print("[!] pydub not installed. Audio conversion may be limited.")
...
try:
    ...
    print("[!] speech_recognition not installed. Using Groq API only.")
    SR_AVAILABLE = False
...
try:
    ...
    print("[!] PIL not installed. Image processing unavailable.")
    PIL_AVAILABLE = False
...
try:
    ...
    print("[!] PDF libraries not installed. PDF processing unavailable.")
    PDF_AVAILABLE = False
...
def main():
    ...
    if nodejs_client.health_check():
        ...
        print(f"[!] Node.js backend not reachable at {Config.NODE_BACKEND_URL}")
